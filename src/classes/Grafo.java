...
public class Grafo {
    ...
    public Grafo() { lista_vertices = new HashMap<Integer, Vertice>(); }
    private Boolean aciclico = null;
...
//        add_arc( id2, id1 );
    ...
    public Grafo grafo_subjacente() {
        Grafo grafo_subjacente = this.clone();
    ...
    public boolean eh_conexo() {
        ...
        while (this.lista_vertices.get(id_raiz) == null)
            id_raiz++;
        Grafo abl = this.busca_largura(id_raiz);
    ...
    public Grafo busca_largura( Integer id_raiz ) {
        Grafo abl = new Grafo();
    ...
    private void visitar_busca_profundidade(Vertice v1){
